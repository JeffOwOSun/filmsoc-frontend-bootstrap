...
cr.define('cr.view.news', function () {
    ...
    function Initialization() {
        //news_setup returns an anonymous function that serves as the callback function when a parseHash is called upon
        //correspondent hash tag
    ...
    function news_detail(id) {
        ...
        cr.model.News.get(id, function (news) {
            ...
            routerManager.markTracker();
            var news_page = cr.ui.template.render_template("news_detail.html", {
                news: news
            });
